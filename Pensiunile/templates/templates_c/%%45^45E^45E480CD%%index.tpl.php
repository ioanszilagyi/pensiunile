<?php /* Smarty version 2.6.20, created on 2008-09-22 05:41:16
         compiled from index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'index.tpl', 21, false),)), $this); ?>
    ...
    <div id="2" style="border-bottom:#41583a solid 1px; border-left:#41583a solid 1px; border-right:#41583a solid 1px; padding:20px 20px 20px 20px">
    	<div id="3" style="border:solid 1px #cbd69d; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px; color:#41583a; padding:10px 0 10px 0" align="center" >
    	  <table width="920" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="370" height="30" align="right" valign="middle" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px; color:#41583a; "><strong class="label">* <?php echo $this->_tpl_vars['nume_pensiune']; ?>
</strong></td>
            ...
            <tr>
              <td height="30" align="right" valign="middle"><strong class="label">* <?php echo $this->_tpl_vars['categoria']; ?>
</strong></td>
            ...
            <tr>
              <td height="30" align="right" valign="middle"><strong class="label"><?php echo $this->_tpl_vars['descriere_pensiune']; ?>
<br />
        ...
        <div id="4" style="border:solid 1px #cbd69d; font:Verdana, Arial, Helvetica, sans-serif; font-size:14px; color:#41583a; padding:10px 0 10px 0" align="center" >
          <table width="920" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="370" height="30" align="right" valign="middle" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px; color:#41583a; "><strong class="label">* <?php echo $this->_tpl_vars['persoana_contact']; ?>
</strong></td>
              <td width="550" height="30" valign="middle">&nbsp;&nbsp;
                  <label>
            ...
            <tr>
              <td height="30" align="right" valign="middle"><strong class="label">* <?php echo $this->_tpl_vars['telefon']; ?>
</strong></td>
              <td height="30" valign="middle">&nbsp;&nbsp;
                  <label>
...
&nbsp;&nbsp;<span class="txt_explicativ">(ex: 0123456789)</span></label></td>
            ...
            <tr>
              <td height="30" align="right" valign="middle"><strong class="label">* <?php echo $this->_tpl_vars['email']; ?>
</strong></td>
              <td height="30" valign="middle">&nbsp;&nbsp;
                  <label>
...
&nbsp;&nbsp;<span class="txt_explicativ">(ex: contact@pensiunile.ro)</span></label></td>
            ...
            <tr>
              <td height="30" align="right" valign="middle"><strong class="label"><?php echo $this->_tpl_vars['adresa_web']; ?>
</strong></td>
              <td height="30" valign="middle">&nbsp;&nbsp;
                <label>
...
<select name="localitate" class="camp_oblig" id="localitate" accesskey="l" tabindex="10">
	<?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['idLocalitate'],'output' => $this->_tpl_vars['namesLocalitate'],'selected' => $this->_tpl_vars['selectedLocalitate']), $this);?>
    	  ...
    	  <table width="920" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="370" height="30" align="right" valign="middle" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px; color:#41583a; ">
                <input type="reset" name="btn_renunta" id="btn_renunta" value="Renunta" tabindex="19" />              </td>
              <td width="550" height="30" valign="middle">&nbsp;&nbsp;
                <label><span style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px; color:#41583a; ">
                <input type="submit" name="btn_renunta2" id="btn_renunta2" value="Inregistrez&#259; pensiunea" tabindex="19" />
                </span></label></td>
            </tr>
          </table> 
    	</div>    </div>
