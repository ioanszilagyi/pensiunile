<?php /* Smarty version 2.6.20, created on 2008-10-10 00:36:05
         compiled from inregistrare_pensiune_ro.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'inregistrare_pensiune_ro.tpl', 22, false),)), $this); ?>
...
<select name="localitate" class="camp_oblig" id="localitate" accesskey="l" tabindex="10">
	<option>Selecteaza Judetul</option><!--<?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['idLocalitate'],'output' => $this->_tpl_vars['namesLocalitate'],'selected' => $this->_tpl_vars['selectedLocalitate']), $this);?>
-->
</select>
