...
<table width="1000" border="0" cellpadding="0" cellspacing="1" class="afisare_cautare">
	...
	<tr>
	  ...
	  <td width="80" align="right" valign="middle" class="text">Adresa:</td><td class="text_evidentiat" width="344">calea Timisoarei nr. 45A, Arad, ARAD</td>
		...
		<td width="21" height="20" class="text_evidentiat"><img src="images/parcare-2.png" alt="parcare" width="20" height="20" title="parcare" /></td>
		<td width="21" height="20" class="text_evidentiat"><img src="images/tv-salon-2.png" alt="televizor in salon" width="20" height="20" title="televizor in calon" /></td>
		<td width="23" height="20" class="text_evidentiat"><img src="images/dus-camera-2.png" alt="dus in camere" width="20" height="20" title="dus in camera" /></td>
	</tr>
	<tr>
	  ...
	  <td height="20" align="right" valign="middle" class="text">Telefon:</td><td height="20" class="text_evidentiat">+40 720 654321</td><td height="20" align="right" valign="middle" class="text">Apreciere:</td>
		...
		<td width="21" height="20" class="text_evidentiat"><img src="images/restaurant-2.png" alt="restaurant" width="20" height="20" title="restaurant" /></td>
		<td width="21" height="20" class="text_evidentiat"><img src="images/cafe-bar-2.png" alt="cafe-bar" width="20" height="20" title="cafe-bar" /></td>
		<td width="23" height="20" class="text_evidentiat"><img src="images/sala-de-mese-2.png" alt="sala de mese" width="20" height="20" title="sala de mese" /></td>
	</tr>
	<tr>
	  ...
	  <td height="20" class="text_evidentiat">pensiune2@test.ro</td>
		...
		<td width="21" height="20" class="text_evidentiat"><img src="images/internet-salon-2.png" alt="internet" width="20" height="20" title="internet in salon" /></td>
		<td width="21" height="20" class="text_evidentiat"><img src="images/internet-wireless-2.png" alt="internet wireles" width="20" height="20" title="internet wireless" /></td>
